...
# Django secret key - loaded from environment variable
SECRET_KEY = os.getenv("SECRET_KEY")

# Debug mode should be set to False in production
DEBUG = os.getenv('DEBUG', 'True') == 'True'  # Changed to allow configuration via environment variable
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://8000-nick8735-magnuseventsv1-is68oes4n04.ws-eu111.gitpod.io',  # Fixed typo in URL
...
# Changed to allow configuration via environment variable and default to SQLite for development
...
if USE_AWS:
    AWS_STORAGE_BUCKET_NAME = 'magnus-events'
...
# Ensure default image exists in the appropriate static directory
